...
def send_email(sender_email, password, receiver_email, route='https://www.google.com/'):
  ...
  """
  html2 =         """
  "><b>Here</b></a><br>Or scan this QR code:<br><img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data="""
  html3 = """"/><br><br><br>
       <i>Generated by the Autorouting Application at: <a href="bruh">bruh</a> <br>
