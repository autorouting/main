...
class solve_multi:
    def __init__(self, input_addresses, api_key, num_vehicles, fast_mode_toggled, force_fairness = False, max_workers = 2):
        ...
        self.fast_mode_toggled = fast_mode_toggled
    ...
    def create_data_model(self):
        self.data = {}
        self.data['distance_matrix'] = self.create_distance_matrix()
    ...
    def create_fast_mode_matrix(self):
        ...
        for i in range(len(self.coordpairs)):
            distance_matrix.append([])
            for j in range(len(self.coordpairs)):
                distance_matrix[i].append(self.fast_mode_distance(self.coordpairs[i], self.coordpairs[j]))
