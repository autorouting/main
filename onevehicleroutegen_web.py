...
def main(api_key, fakeinputfile, fast_mode_toggled):
    ...
    # run ORTools
    distancematrix = generate_distance_matrix(fakeinputfile.splitlines(), api_key)
    ...
    route_solution, stringoutput = print_solution(manager, routing, solution, fakeinputfile.splitlines())
    if solution:
        route_solution
