...
def fast_mode_distance(coords1, coords2):
    ...
    lon1 = coords1[1] * 40075000 * math.cos(coords1[0] * math.pi / 180) / 360
    lon2 = coords2[1] * 40075000 * math.cos(coords2[0] * math.pi / 180) / 360
    lat1 = coords1[0] * 111320
    lat2 = coords2[0] * 111320
