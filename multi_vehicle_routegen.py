...
def main():
    ...
    for i in range(len(end_points)):
        coords.append((float(end_points[i].replace("https://www.google.com/maps/place/", "").split("/")[1].replace("@", "").split(",")[0]), float(end_points[i].replace("https://www.google.com/maps/place/", "").split("/")[1].replace("@", "").split(",")[1])))
